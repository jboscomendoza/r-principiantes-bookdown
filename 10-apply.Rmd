...
La familía de funciones **apply** es una expresión del paradigma funcional de programación. Sobre esto no profundizaremos demasiado. Basta saber que en este paradigma las funciones son "ciudadanos de primera", con la misma importancia que los objetos, y por lo tanto, operamos en ellas. La familia de funciones apply recibe funciones como argumentos, no sólo objetos.

## Un recordatorio sobre vectorización
Para entender la familia apply, empecemos recordarndo que en R podemos vectorizar operaciones.
...
Cuando vecotorizamos, la operación es aplicada a cada elemento en un vector. Es una alternativa, generalmente deseable a escribir una operación para cada elemento o usar un bucle **for** (como se describió en Estructuras de control).
...
La familia de funciones **apply** nos permite realizar lo anterior en estructuras de datos distintas  los vectores, de más de una dimensión.
...
Luce como un panorama abrumador. En realidad, no estoy seguro si me faltó incluir alguna función de la familia **apply** en la lista anterior.

La variedad de funciones se debe a que muchas de ellas son usadas para casos muy específicos. Como estamos aprendiendo a usar R, nos concentraremos en las funciones más generales y de uso común.

- apply
- lapply

Conociendo el uso de estas dos funciones, las demás son relativamente fáciles de entender.
...
Ha sido un proceso un poco más largo de lo que anticipaba, pero con **apply** y **lapply**, en conjunto con todo lo que hemos revisado anteriormente, tienes suficientes herramientas para resolver problemas complejos usando R.

Eso es precisamente lo que haremos.

Crearemos una función para obtener estadísticos de las bases de datos de ECEA, lo cual implica la estimación de errores estándar de medida con pesos muestrales replicados (método BRR con corrección de Fay).
