# Tipos de datos
Los tipos de datos más usados en R son los siguientes.
...
Función         | Tipo al que hace coerción | Ejemplo
-----           | -----                     |----
as.integer()    | Entero                    | integer
as.numeric()    | Numerico                  | numeric
as.complex()    | 1+0i                      | complex
as.character()  | Cadena de texto           | "uno"
as.factor()     | Factor                    | factor
as.logical()    | Lógico                    | logical
as.null()       | NULL                      | null
